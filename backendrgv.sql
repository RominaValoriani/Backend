...
--
-- Host: localhost    Database: backendrgv
-- ------------------------------------------------------
...
INSERT INTO `persona` VALUES (4,'Valoriani','URLdeimg','Romina',NULL);
...
CREATE TABLE `rol` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `rol_nombre` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-06-27 17:11:57
